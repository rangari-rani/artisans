...
const Navbar = () => {
  ...
  <div
    className="group-hover:block hidden absolute dropdown-menu right-0 -top-full pt-4 z-50"
    style={{ position: 'absolute', zIndex: 50 }}
  >
    <div className="flex flex-col items-center gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow-lg">
